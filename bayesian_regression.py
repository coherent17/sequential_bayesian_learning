...
p=ax.scatter(weight0, weight1, weight2, c=weight2, cmap='rainbow', linewidth=0.5);
fig.colorbar(p, ax=ax)
plt.show()


        # weight_0_list = np.array(weight_0_list)
        # weight_0_list = np.reshape(weight_0_list,(weight_0_list.shape[0],))
        # print(weight_0_list.shape)
        # weight_1_list = np.array(weight_1_list)
        # weight_1_list = np.reshape(weight_1_list,(weight_1_list.shape[0],))
        # plt.hist2d(np.array(weight_0_list),np.array(weight_1_list),bins = 50,cmap = 'rainbow')
        # plt.xlabel('W0')
        # plt.ylabel('W1')
        # plt.show()